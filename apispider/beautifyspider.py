...
AK = 'Ar1kvWvfNe06_XHjjo07LokXi4MERDVl'
SK = 'ERYWBAow05S7ooKWeDgL0YKeOd7yEqJ3'
...
f = open(img_name, 'rb')
# 转 base64
img_base64 = base64.b64encode(f.read())         #Base64就是一种基于64个可打印字符来表示二进制数据的方法
...
# 解析base64图片    由于api接口返回的数据是base64的二进制文件，需要解码
